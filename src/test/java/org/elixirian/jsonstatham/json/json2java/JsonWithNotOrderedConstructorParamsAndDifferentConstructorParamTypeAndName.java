 ...
 */
@Json
public class JsonWithNotOrderedConstructorParamsAndDifferentConstructorParamTypeAndName
{
  ...
  @JsonConstructor
  public JsonWithNotOrderedConstructorParamsAndDifferentConstructorParamTypeAndName(final String note, final Long... selectedServices)
  {
  ...
  public boolean equals(final Object jsonWithNotOrderedConstructorParams)
  {
    ...
    final JsonWithNotOrderedConstructorParamsAndDifferentConstructorParamTypeAndName that =
      castIfInstanceOf(JsonWithNotOrderedConstructorParamsAndDifferentConstructorParamTypeAndName.class, jsonWithNotOrderedConstructorParams);
    /* @formatter:off */
    return null != that &&
