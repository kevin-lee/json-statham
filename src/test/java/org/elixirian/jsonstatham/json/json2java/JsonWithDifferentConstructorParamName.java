 ...
 */
@Json
public class JsonWithDifferentConstructorParamName
{
  ...
  @JsonConstructor
  public JsonWithDifferentConstructorParamName(final List<Long> selectedServices, final String note)
  {
    this.selectedServiceIdList = selectedServices;
    this.note = note;
  }
  ...
  public boolean equals(final Object jsonWithNotOrderedConstructorParams)
  {
    ...
    final JsonWithDifferentConstructorParamName that =
      castIfInstanceOf(JsonWithDifferentConstructorParamName.class, jsonWithNotOrderedConstructorParams);
    /* @formatter:off */
    return null != that &&
