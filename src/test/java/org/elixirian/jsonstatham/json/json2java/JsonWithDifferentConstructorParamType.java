...
public class JsonWithDifferentConstructorParamType
{
  ...
  @JsonConstructor
  public JsonWithDifferentConstructorParamType(final Long[] selectedServiceIdList, final String note)
  {
    this.selectedServiceIdList = newArrayList(selectedServiceIdList);
    this.note = note;
  }
