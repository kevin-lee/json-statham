 ...
 * @version 0.0.7 (2010-02-12) The name is changed from NonIndentedJsonStatham to JsonStathamInAction. When the JsonObject is converted into
 *          JSON, if any fields annotated with @JsonField without the 'name' element explicitly set, it will use the actual field names as
 *          the JsonField names.
