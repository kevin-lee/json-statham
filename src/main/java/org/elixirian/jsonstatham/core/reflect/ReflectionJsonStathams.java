...
import org.elixirian.jsonstatham.core.convertible.UnorderedJsonScannerCreator;
...
public final class ReflectionJsonStathams
{
  ...
  {
    final JsonScannerCreator jsonScannerCreator = new OrderedJsonScannerCreator();
    ...
    return newReflectionJsonStathamInAction(DefaultJsonToJavaConfig.builder(jsonScannerCreator,
        orderedJsonObjectCreator, jsonArrayCreator)
        .build());
  }
  ...
  public static JsonStathamInAction newUnorderedReflectionJsonStathamInAction()
  {
    ...
    // final OrgJsonJsonArrayCreator orgJsonJsonArrayConvertibleCreator =
    // new OrgJsonJsonArrayCreator();
    final JsonScannerCreator jsonScannerCreator = new UnorderedJsonScannerCreator();
    ...
    final ReflectionJsonToJavaConverter reflectionJsonToJavaConverter =
      new ReflectionJsonToJavaConverter(DefaultJsonToJavaConfig.builder(jsonScannerCreator, unorderedJsonObjectCreator,
          jsonArrayCreator)
          .build());
