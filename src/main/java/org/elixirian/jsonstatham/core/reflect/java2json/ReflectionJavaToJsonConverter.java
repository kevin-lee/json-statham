...
public class ReflectionJavaToJsonConverter implements JavaToJsonConverter
{
   ...
   */
  private JsonObject createJsonObject(final Object sourceObject) throws IllegalArgumentException,
      ...
      throws IllegalArgumentException, IllegalAccessException, JsonStathamException
  {
    if (null == source)
    {
      charAndStringWritable.write((String) source);
      return;
    }
    ...
    if (null != knownTypeProcessorWithReflectionJavaToJsonConverter)
    {
      final JsonConvertible jsonConvertible =
        (JsonConvertible) knownTypeProcessorWithReflectionJavaToJsonConverter.process(this, sourceType, source);
      jsonConvertible.write(charAndStringWritable);
      return;
    }

    createJsonObject(source).write(charAndStringWritable);
  }
}
